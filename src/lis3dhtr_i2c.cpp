...
void lis3dhtr_i2c::verify_device()
{
...
void lis3dhtr_i2c::configure_full_scale(max_acceleration p_gravity_code)
{
  ...
  auto ctrl_reg4_data = hal::write_then_read<1>(
...
accelerometer::read_t lis3dhtr_i2c::driver_read()
{
